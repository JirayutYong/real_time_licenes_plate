...
def imgwrite(img):
    ...
    filename_car = '%s.png' % current_time
...
def save_license_plate(img):
    ...
    filename_license = '%s.png' % current_license
                        ...
                        if car_id != -1:
                            ...
                            for p_file in pred_files:
                                ...
                                recognition_output = license_plate_recognition.predict(
                                    source=os.path.join("capture_license_to_pred", p_file), conf=0.4, save=True)
                                ...
                                new_data = {
                                    ...
                                    "img_license_path": "images/licenses/"+minio_path_plate
